...
/**
 * Luokka kuvaa pelissä esiintyvää oliota, joka reagoi muihin peliolioihin sekä piirretään
 * peliin.
 * @author wolli
 */
...
public abstract class Peliolio {
    ...
    /**
     * Luokan konstruktori.
     * Asettaa x- ja y-arvot, jotka kuvaavat pistettä koordinaatistossa.
    ...
    /**
     * Metodi sisältää tiedon siitä, kuinka perivän luokan tulee käyttäytyä,
     * kun toisen peliolion hitbox osuu luokan omaan hitboxiin.
